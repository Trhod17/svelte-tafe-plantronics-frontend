...
const Themeswitch = (0, import_index_2c175e7b.c)(($$result, $$props, $$bindings, slots) => {
...
const Navbar = (0, import_index_2c175e7b.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"navbar bg-primary"}"><div class="${"navbar-start"}"><div class="${"dropdown bg-primary"}">
			...
			<ul tabindex="${"0"}" class="${"menu dropdown-content mt-4 p-5 shadow bg-primary text-primary-content rounded-box w-60"}"><li class="${"mx-auto"}"><a sveltekit:prefetch class="${"text-lg"}" href="${"/"}"><i class="${"fa-solid fa-house"}"></i>Home</a></li>
				...
				${$store != null ? `<li class="${"mx-auto"}"><a sveltekit:prefetch class="${"text-lg"}" href="${"/profile"}"><i class="${"fa-solid fa-user"}"></i>${(0, import_index_2c175e7b.e)($store[0])}</a></li>
	...
	<div class="${"navbar-center hidden lg:flex"}"><ul class="${"menu menu-horizontal p-0"}"><li><a sveltekit:prefetch href="${"/"}"><i class="${"fa-solid fa-house"}"></i>Home</a></li>
			...
			${$store != null ? `<li><a sveltekit:prefetch href="${"/profile"}"><i class="${"fa-solid fa-user"}"></i>${(0, import_index_2c175e7b.e)($store[0])}</a></li>
	...
	<div class="${"navbar-end"}">${(0, import_index_2c175e7b.v)(Themeswitch, "ThemeSelect").$$render($$result, {}, {}, {})}</div></div>`;
});
var app = "";
const _layout = (0, import_index_2c175e7b.c)(($$result, $$props, $$bindings, slots) => {
...
${(0, import_index_2c175e7b.v)(Navbar, "NavBar").$$render($$result, {}, {}, {})}
